...
<body>
    ...
    <div class="form">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<table>";
            echo "<tr><th>Id Alumno</th><th>Nombre del alumno</th><th>Fecha de Pago</th><th>Paquete/Clase</th><th>Banco</th><th>Folio</th><th>Comprobante</th><th>Estado</th></tr>";

            while($row = $result->fetch_assoc()) {
                $paquete_o_clase = ($row['paquete_o_clase'] == 1) ? 'Paquete' : 'Clase';
                // Aquí mostramos el estado de pago (debería ser 'pagado' o 'atrasado')
                echo "<tr>
                        <td>" . $row['id_alumno'] . "</td>
